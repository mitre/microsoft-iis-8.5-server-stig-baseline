...
This project is licensed under the terms of the [Apache 2.0 license](https://github.com/mitre/microsoft-iis-8.5-server-stig-baseline/blob/master/LICENSE.md).
